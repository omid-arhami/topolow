...
# inst/scripts/run_topolow_arguments.R
...
k_decay <- as.numeric(args[5])
cqq <- as.numeric(args[6])
...
hyperparam_dir <- file.path(output_dir, "run_topolow_arguments")
...
# Save results
output_file <- file.path(hyperparam_dir,
                         paste0(i, "_hyperparams_", scenario_name, ".csv"))

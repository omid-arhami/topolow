...
```{r eval=FALSE}
scenario_name = "H3N2_2003_data_AMC01"
samples_file = "model_parameters/H3N2_2003_data_AMC01_model_parameters.csv"
...
amc_params <- list(
  num_samples = 5, # Number of new samples to be added to the parameter distribution through AMC (for refinement.) If using SLURM, can set = num_parallel_jobs for better accounting.
...
#write.csv(positions, "data_files/H3N2_Positions.csv", row.names=FALSE)
```

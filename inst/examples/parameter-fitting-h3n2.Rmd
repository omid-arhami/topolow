...
```{r eval=FALSE}
scenario_name = "H3N2_2003_data_AMC12"
samples_file = "model_parameters/H3N2_2003_data_AMC12_model_parameters.csv"
...
amc_params <- list(
  num_samples = 50, # Number of new samples to be added to the parameter distribution through AMC (for refinement.) If using SLURM, can set = num_parallel_jobs for better accounting.

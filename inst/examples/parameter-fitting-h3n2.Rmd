...
results <- run_parameter_optimization(
  ...
  scenario_name = "H3N2_2003_data_AMC10",
...
scenario_name = "H3N2_2003_data_AMC9"
samples_file = "model_parameters/H3N2_2003_data_AMC9_model_parameters.csv"
samples <- log_transform_parameters(samples_file)

# Setup adaptive sampling parameters
amc_params <- list(
  num_samples = 1000,  # Total samples to collect
  n_iter = 3,        # Number of consecutive iterations at each parallel job

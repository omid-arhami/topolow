...
```{r eval=FALSE}
scenario_name = "H3N2_2003_data_subsample_AMC2"
samples_file = "model_parameters/H3N2_2003_data_subsample_AMC2_model_parameters.csv"
...
scenario_name = "H3N2_2003_data_subsample_AMC2"
samples_file = file.path(output_dir, "model_parameters/H3N2_2003_data_subsample_AMC2_model_parameters.csv")

# Setup adaptive sampling parameters
amc_params <- list(
  num_samples = 2, # Number of new samples to be added to the parameter distribution through AMC (for refinement.) 

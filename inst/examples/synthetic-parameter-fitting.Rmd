...
There are 27 combinations. Therefore, to run the simulation in this script, distributed processing is certainly needed.
...
amc_params <- list(
  num_parallel_jobs = 200,  # For local execution: Number of CPU cores available; For SLURM: Number of samples

...
opt_params <- list(
  ...
  topolow_params = read.csv("optimal_parameters_250points_AMC102.csv"),  # From parameter fitting
  use_slurm = FALSE,
  num_cores = 87
)
...
# Save plot
ggsave("Method_comparison_MAPE_plot_250points_AMC102.pdf", plot = p, width = 172, height = 0.5*172, units = "mm", dpi = 300)

...
opt_params <- list(
  ...
  parallel_jobs = 30,   # For local execution: Number of CPU cores available; For SLURM: Number of jobs to submit
...
amc_params <- list(
  ...
  iterations = 5,        # Number of consecutive iterations at each parallel job (for refinement.) Can set = 1 for better for SLURM accounting.

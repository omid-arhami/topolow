...
amc_params <- list(
  num_samples = 10, # Number of new samples to be added to the parameter distribution through AMC (for refinement.) If using SLURM, can set = num_parallel_jobs for better accounting.
...
for (param in params) {
  ...
  # Plot results
  sens_plot <- plot(sensitivity, reference_error = 1.3) # , reference_error = 2.231

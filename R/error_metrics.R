...
#' correlations, and coverage statistics for model evaluation.
#'
#' @details
...
#'   \item{InSampleCor}{Correlation for in-sample predictions}
#'   \item{OutSampleCor}{Correlation for out-of-sample predictions}
#' @export

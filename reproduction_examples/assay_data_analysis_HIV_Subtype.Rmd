...
opt_params <- list(
  ...
  num_samples = 30,   # Number of LHS samples
...
amc_params <- list(
  ...
  n_iter = 5,        # Number of consecutive iterations at each parallel job
...
run_adaptive_sampling(
  initial_samples_file = "model_parameters/HIV_BC_AMC1_model_parameters.csv",
  distance_matrix = hiv_distance_matrix,
